...
//need to use square brackets if there is a space in the variable
//if there is a space in the key might need to add '' around key, also true for accessing object
